...
class UpdateService:
    ...
    @staticmethod
    @transaction.atomic
    def update_entity_idempotent(entity_uid: str, payload: Dict[str, Any], change_ts: Optional[datetime] = None) -> tuple[Entity, bool]:
        """
    ...
    @staticmethod
    @transaction.atomic
    def update_entity(entity_uid: str, payload: Dict[str, Any]) -> Entity | None:
        """Legacy update method for backward compatibility."""
        try:
            entity, _ = UpdateService.update_entity_idempotent(entity_uid, payload)
            return entity
        except ValueError:
            return None